...
import imgeee from "../../assets/images/placeholder-2@2x.png";
...
const VidCard = ({
  ...
  return (
    <>
      {/* <div className={`${classes.videoCard} card vid-card border-0`}> */}
      <div className={`card vid-card border-0`}>
        {playVideo && <VideoPlayer {...videoJsOptions} image={image} />}
        {!playVideo && (
          <>
            {/* {image && <img src={image} className="vid-card-image" />} */}
